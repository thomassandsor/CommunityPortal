                ...
                <div className="mt-16 text-center">
                    <div className="bg-white rounded-xl shadow-sm border p-8">
                        ...
                        <p className="text-gray-600 max-w-3xl mx-auto">
                            This Community Portal serves as a starter template for developers who want to learn
                            how to integrate React applications with Microsoft Dataverse. Fork the project,
                            follow the setup guide, and start building your own community solutions.
                        </p>
                        <div className="mt-6">
                            <a
